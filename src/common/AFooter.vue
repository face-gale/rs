        ...
        <div class="container">
            <div class="siteinfo">
                <ul class="c0">
                    ...
                    <ul>
                        ...
                        <li class="c2"><a class="c3" @click="open4">产品渠道</a></li>
                ...
                <ul class="c0">
                    ...
                    <ul>
                        ...
                        <li class="c2">
                            <a class="c3" target="_blank" href="https://www.baidu.com"
                            >Baidu</a
                            >
                        </li>-->
                        <li class="c2" v-for="item in planContent">
                            <a  class="c3" @click="">{{ item.panelTitle }}</a>
                        </li>
                    </ul>
                </ul>
                <ul class="c0">
                    ...
                    <ul>
                        <li class="c2">
                            <a class="c3" target="_self" href="#/demons">演示</a>
                        </li>
                    </ul>
                </ul>
                <ul class="c0">
                    ...
                    <ul>
                        <li class="c2">
                            <a class="c3" target="_blank" href="">腾讯 QQ</a>
                        </li>
                        <li class="c2">
                            <a class="c3" target="_blank" href="">新浪微博</a>
                        </li>
                        <li class="c2">
                            <a class="c3" target="_blank" href="">官方邮箱</a>
                        </li>
                    </ul>
                </ul>
                ...
                <ul class="c4">
                    <ul class="right-c">
                        <li class="tel">
                            <a
                                    class="c5"
                                    href="http://wpa.qq.com/msgrd?v=3&uin=297157112&site=qq&menu=yes"
                                    target="_blank"
                            >297157112</a
                            >
                        </li>
            ...
            <div class="copyright">
                ...
                <ul class="privacy">
                    ...
                    <li class="content-c1">
                        <a class="content-c0" target="_blank" href="">开发者中心</a>
                    </li>
                </ul>
            </div>
            <div class="cop">
...
<script>
    import {contentArray} from "../views/plan-center/desc/plan";
