        ...
        <div class="nav-list">
            <div class="nav-row">
                <el-row type="flex" class="row-bg" justify="center">
                    <el-col :span="6" class="bg-col" v-for="(item, i) in planContent" :key="i" :class="{ change: i !==  planContent.length-1 }">
...
<script>
    ...
    import {contentArray} from "./desc/plan";
    ...
    export default {
        ...
        created() {
            this.changeContent(0,contentArray[0])
        },
        components: {
