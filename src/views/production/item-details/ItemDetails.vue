...
<script>
  ...
  export default {
    data () {
      return {
        // productMsg: {},
        productMsg: '1111111111111111111' +'<br>'+'111111111111111111111' +'<br>'+'11111111111111111111' +'<br>'+'1111111111111111' +'<br>'+'111111111111111111111111111' +'<br>'+'1111111111111111111111',
        small: [
          'http://seopic.699pic.com/photo/40147/6876.jpg_wh1200.jpg'
        ],
        big: '',
        product: {
          salePrice: 0
